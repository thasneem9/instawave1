...
//updates during connection bw frontendandbackend:
//1.changed allmessage:toerror:..unles its a status 200--to lookmore readable LOL-_-
//for our folowunfolow:
...
try {
       ...
       /*  if (req.params.id !==userId.toString())//convertingto stringbcsits an object
            return res.status(400).json({error:`youcant update other people's profile ${userId}`}) */
