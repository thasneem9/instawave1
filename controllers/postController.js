...
// controllers/postController.js
// Controller function to get saved posts
...
const getSavedPosts = async (req, res) => {
    try {
     ...
     /*    res.status(200).json(bookmarks); */
      /*   console.log('Test Query Result:', bookmarks);  */
      //---------------------------------------------------------------]
...
const getFeed=async(req,res)=>{
 ...
 /*   res.status(200).json({message:"succesfully updated feed",feedPosts}) instead of returning an object return the feed */
